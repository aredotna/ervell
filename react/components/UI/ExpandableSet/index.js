...
import UnwrappedExpandable from 'react/components/UI/Expandable';
...
export class Expandable extends Component {
  ...
  render() {
    const {
      children, nLines, forFontSize, forLineHeight, ...rest
    } = this.props;

    const height = `${calculateLineHeight(forFontSize, forLineHeight) * nLines}rem`;

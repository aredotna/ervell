...
import serializedMeQuery from 'react/hocs/WithSerializedMe/queries/serializedMe';
...
const withSerializedMe = (WrappedComponent) => {
  class WithSerializedMe extends Component {
    ...
    render() {
      const { data: { serializedMe }, ...rest } = this.props;

      return (
        <WrappedComponent serializedMe={serializedMe} {...rest} />
      );
    }
  }

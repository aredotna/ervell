...
export default () => {
  ...
  mediator.shared.state = mediator.shared.state || new UIState({ view_mode: 'grid' });
  mediator.shared.current_user = mediator.shared.current_user || new CurrentUser(CURRENT_USER);

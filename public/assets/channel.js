...
var $, Backbone, Channel, ChannelView, headerTemplate, sd,
...
headerTemplate = function() {
  return require("./templates/header.jade").apply(null, arguments);
};
...
module.exports.ChannelView = ChannelView = (function(_super) {
  ...
  ChannelView.prototype.render = function() {
    console.log(this.model, "RENDERSSSSS");
...
},{"../../models/channel.coffee":4,"./templates/header.jade":2,"backbone":5,"jquery":8,"sharify":9}],2:[function(require,module,exports){
...
buf.push("<p>" + (jade.escape(null == (jade_interp = channel.get('title')) ? "" : jade_interp)) + "</p>");}("channel" in locals_for_with?locals_for_with.channel:typeof channel!=="undefined"?channel:undefined));;return buf.join("");
};
},{"jade/runtime":7}],3:[function(require,module,exports){
require('jquery')(require("../apps/channel/client.coffee").init);


},{"../apps/channel/client.coffee":1,"jquery":8}],4:[function(require,module,exports){
var Backbone, Channel, sd,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
module.exports = Channel = (function(_super) {
  ...
  Channel.prototype.url = function() {
    return "" + sd.API_URL + "/channels/" + this.slug;
  };
...
},{"backbone":5,"sharify":9}],5:[function(require,module,exports){
//     Backbone.js 1.1.2

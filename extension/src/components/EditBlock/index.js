...
class EditBlock extends PureComponent {
  ...
  onSave = (e) => {
    ...
    const { context: { editBlock } } = this.props;
  ...
  getCurrentBlock = () => {
    const { match, context: { getBlock } } = this.props;
    ...
    return (
      <form onSubmit={this.onSave}>
        <Container>
          ...
          <Box justifyContent="center" alignItems="stretch" display="flex" flexDirection="column" width="100%">
            {block.type === 'Image' &&
            ...
            <Box justifyContent="center" alignItems="stretch" display="flex" flexDirection="column">
              <Text f={1} fontWeight="bold" mb={3}>Title</Text>
              <Input
                mb={7}
                placeholder="Title"
                tabIndex={0}
              ...
              <Text f={1} fontWeight="bold" mb={3}>Description</Text>
              <Textarea
                mb={6}
          ...
          <Bottom>
            <Button type="submit" f={4} mb={4}>Save</Button>
            <Cancel>

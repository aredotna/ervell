...
var Browser = (function (_EventEmitter) {
  ...
  _createClass(Browser, [{
    ...
    value: function wait(options, callback) {
      ...
      if (callback) _eventLoop.wait(waitDuration, completionFunction, callback);else return Bluebird.promisify(_eventLoop.wait, _eventLoop)(waitDuration, completionFunction);
    }

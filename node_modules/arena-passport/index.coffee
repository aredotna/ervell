...
# Hoist the XAUTH token out of a request and store it at the module level for
# the passport callbacks to access.
arena_xauth_token = null
...
signup = (req, res, next) ->
  request.put(opts.SECURE_ARENA_URL + '/v2/accounts/invitation').send(
    ...
    xapp_token: res.locals.arenaXappToken
...
addLocals = (req, res, next) ->
  if req.user
    ...
    res.locals.sd?.X_AUTH_TOKEN = module.exports.arena_xauth_token = req.user.get('authentication_token')
  next()

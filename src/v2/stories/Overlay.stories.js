...
storiesOf('Overlay', module).add('configurations', () => (
  <Specimen>
    <OverlaidUserDropdown align="left" anchorX="left" />

    <OverlaidUserDropdown align="right" anchorX="right" alignToX="right" />

    <OverlaidUserDropdown align="left" anchorY="bottom" alignToY="top" />

...
export default class GroupsPage extends Component {
  render() {
    return (
      <Container>
        <CenterBox mb={9}>
          <Headline>Getting started with Groups</Headline>
          <Subheadline>
        ...
        <Content>
          <CTA>
            <CenterBox mt={9} mb={10}>
              ...
              <Description align="left" my={7}>
                Every group has a profile page where you can see all your shared
              ...
              <Instructions>
                ...
                <ol>
                  <li>
                    1. Click <strong>+ New group</strong> in the main dropdown
                    menu.
                  </li>
                  <li>
                    2. Name your group, choose a privacy setting, and add
                    members.
                  </li>
                ...
                <ol>
                  <li>
                    1. Once you’ve made your group, click on{' '}
                    <strong>+ New channel</strong>.
                  </li>
                  <li>
                    2. Under <strong>channel author</strong>, select the
                    preferred group.
                  </li>
            ...
            <CenterBox mt={9} mb={10}>
              ...
              <Description align="left" my={7}>
                Quickly add your whole team to new channels. Keep work and
                personal content separate.
              </Description>
              ...
              <Instructions>
                ...
                <ol>
                  <li>
                    1. Go to your group and click the <strong>settings</strong>{' '}
                    button on the right.
                  </li>
                  <li>
                    2. Under <strong>manage members</strong>, search for members
                    to invite or enter an email address.
                  </li>
                </ol>
                <br />
                <div>To collaborate with a group:</div>
                <div>
                  Click <strong>add collaborators</strong> at the top of any
                  channel and enter the name of the group.
                </div>
              </Instructions>
            </CenterBox>
            <CenterBox mt={9} mb={10}>
              ...
              <Description align="left" my={7}>
                Billing is simple for professional teams. Invite members and
                upgrade as you go.
              </Description>
              ...
              <Instructions>
                ...
                <ol>
                  <li>1. Click on the group name in the main menu.</li>
                  <li>
                    2. Under <strong>manage members</strong>, click{' '}
                    <strong>Upgrade members</strong>
                  </li>
                  <li>3. Select members and enter your card information.</li>
                </ol>
              </Instructions>
            </CenterBox>
          </CTA>
          ...
          <CTA>
            <CenterBox my={10}>
              <Subheadline>More Features</Subheadline>
              <Description>
                Learn more about group features, privacy settings, and
                transferring existing channels.
              </Description>
              <Button
                f={5}
                mt={6}
                py={6}
                href="http://help.are.na/knowledge_base/categories/feature-updates-1"
              >
                Groups FAQs
              </Button>
            </CenterBox>

...
export const FONT_SIZE_SCALE = __FONT_SIZE_SCALE__.map(
  name => FONT_SIZES[name]
);
...
export const __LINE_HEIGHT_SCALE__ = ['compact', 'base', 'tall'];

export const LINE_HEIGHT_SCALE = __LINE_HEIGHT_SCALE__.map(
  name => LINE_HEIGHTS[name]
);
...
export const FONT_FAMILIES = {
  ...
  mono:
    "Menlo, Monaco, 'Bitstream Vera Sans Mono', Consolas, Courier, monospace",
};

...
import { BlockLightboxShare as BlockLightboxShareType } from '__generated__/BlockLightboxShare'
...
interface BlockLightboxShareProps {
  block: BlockLightboxShareType
}

export const BlockLightboxShare: React.FC<BlockLightboxShareProps> = ({
  block,
}) => {
...
export default BlockLightboxShare

...
import { ReaderContainer } from 'v2/components/FullBlock/components/FullBlockLink/components/FullBlockLinkReader/components/ReaderContainer'
...
import BLOCK_CANONICAL_LINK_READER_QUERY from 'v2/components/FullBlock/components/FullBlockLink/components/FullBlockLinkReader/queries/canonicalLinkReader'
import REGENERATE_CANONICAL_LINK_MUTATION from 'v2/components/FullBlock/components/FullBlockLink/components/FullBlockLinkReader/mutations/regenerateCanonicalLinkMutation'
...
interface FullBlockLinkReaderInnerProps {
...
const FullBlockLinkReaderInner: React.FC<FullBlockLinkReaderInnerProps> = ({
  block,
  startPolling,
  stopPolling,
  loading,
...
export const FullBlockLinkReader: React.FC<FullBlockLinkProps> = ({
  block,
  layout,
}) => {

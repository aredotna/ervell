...
import BLOCK_IMAGE_URL_QUERY from 'v2/components/FullBlock/components/FullBlockActions/components/FullBlockChangeThumbnail/queries/blockImageUrl'
import UPDATE_BLOCK_THUMBNAIL_MUTATION from 'v2/components/FullBlock/components/FullBlockActions/components/FullBlockChangeThumbnail/mutations/changeThumbnail'

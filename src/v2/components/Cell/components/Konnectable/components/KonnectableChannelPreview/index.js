...
import KonnectableChannelPreviewBlocks from 'v2/components/Cell/components/Konnectable/components/KonnectableChannelPreviewBlocks'
...
export default class KonnectableChannelPreview extends PureComponent {
  static propTypes = {
        ...
        <Preview>
          ...
          >
            {({ data, error, loading }) => {
              ...
              return (
                <KonnectableChannelPreviewBlocks
                  blocks={blocks}

...
const channelOnboardingCookieName = channelId =>
  `channel-onboarding-${channelId}`
...
export const setChannelOnboardingCookie = channelId => {
  ...
  return Cookies.set(channelOnboardingCookieName(channelId), true)
}
...
export const expireChannelOnboardingCookie = channelId => {
  ...
  return Cookies.expire(channelOnboardingCookieName(channelId))
}

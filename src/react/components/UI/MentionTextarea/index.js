...
import userSuggestionsQuery from 'react/components/UI/MentionTextarea/queries/userSuggestions';

import Box from 'react/components/UI/Box';
import { Textarea } from 'react/components/UI/Inputs';
import MentionTextareaSuggestions from 'react/components/UI/MentionTextarea/components/MentionTextareaSuggestions';
...
export default class MentionTextarea extends PureComponent {
  ...
  toggleSuggestions = ({
    hookType, cursor: {
      top, left, height, selectionStart,
    },
  }) => {
    if (hookType === 'start') {
      this.setState({
        ...
        {mode === 'suggesting' && query !== '' &&
          ...
          >
            {({ loading, error, data }) => {
              ...
              const { suggestions: { users: suggestions } } = data;

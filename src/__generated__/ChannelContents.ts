...
export interface ChannelContents_blokks_Channel {
  ...
  owner: ChannelContents_blokks_Channel_owner;
  label: string;
  can: ChannelContents_blokks_Channel_can | null;
}

export type ChannelContents_blokks = ChannelContents_blokks_Attachment | ChannelContents_blokks_Embed | ChannelContents_blokks_Image | ChannelContents_blokks_Link | ChannelContents_blokks_PendingBlock | ChannelContents_blokks_Text | ChannelContents_blokks_Channel;
...
export interface ChannelContents {
  ...
  blokks: ChannelContents_blokks[] | null;
  visibility: string;
}

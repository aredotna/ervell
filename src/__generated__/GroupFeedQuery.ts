...
export interface GroupFeedQuery_group_feed_groups_objects_Attachment {
  ...
  updated_at: string;
  user: GroupFeedQuery_group_feed_groups_objects_Attachment_user;
  /**
...
export interface GroupFeedQuery_group_feed_groups_objects_Channel {
  ...
  label: string;
  title: string;
  user: GroupFeedQuery_group_feed_groups_objects_Channel_user;
  /**
   * Returns the outer channel if we are inside of one
   */
...
export interface GroupFeedQuery_group_feed_groups_objects_Embed {
  ...
  src_3x: string | null;
  updated_at: string;
  user: GroupFeedQuery_group_feed_groups_objects_Embed_user;
  /**
   * Returns the outer channel if we are inside of one
   */
...
export interface GroupFeedQuery_group_feed_groups_objects_Image {
  ...
  updated_at: string;
  user: GroupFeedQuery_group_feed_groups_objects_Image_user;
  /**
   * Returns the outer channel if we are inside of one
   */
...
export interface GroupFeedQuery_group_feed_groups_objects_Link {
  ...
  content: string | null;
  updated_at: string;
  user: GroupFeedQuery_group_feed_groups_objects_Link_user;
  /**
   * Returns the outer channel if we are inside of one
   */
...
export interface GroupFeedQuery_group_feed_groups_objects_Text {
  ...
  raw: string;
  updated_at: string;
  user: GroupFeedQuery_group_feed_groups_objects_Text_user;
  /**
   * Returns the outer channel if we are inside of one
   */

...
export interface ConnectableBlokk_blokk_Attachment {
  ...
  updated_at: string;
  title: string;
  user: ConnectableBlokk_blokk_Attachment_user;
  /**
...
export interface ConnectableBlokk_blokk_Embed {
  ...
  updated_at: string;
  title: string;
  user: ConnectableBlokk_blokk_Embed_user;
  /**
   * Returns the outer channel if we are inside of one
   */
...
export interface ConnectableBlokk_blokk_Image {
  ...
  updated_at: string;
  title: string;
  user: ConnectableBlokk_blokk_Image_user;
  /**
   * Returns the outer channel if we are inside of one
   */
...
export interface ConnectableBlokk_blokk_Link {
  ...
  updated_at: string;
  title: string;
  user: ConnectableBlokk_blokk_Link_user;
  /**
   * Returns the outer channel if we are inside of one
   */
...
export interface ConnectableBlokk_blokk_PendingBlock {
  ...
  updated_at: string;
  title: string;
  user: ConnectableBlokk_blokk_PendingBlock_user;
  /**
   * Returns the outer channel if we are inside of one
   */
...
export interface ConnectableBlokk_blokk_Text {
  ...
  updated_at: string;
  title: string;
  user: ConnectableBlokk_blokk_Text_user;
  /**
   * Returns the outer channel if we are inside of one
   */
...
export interface ConnectableBlokk_blokk_Channel {
  ...
  updated_at: string;
  title: string;
  user: ConnectableBlokk_blokk_Channel_user;
  /**
   * Returns the outer channel if we are inside of one
   */

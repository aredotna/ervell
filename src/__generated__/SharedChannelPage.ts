...
export interface SharedChannelPage_channel_initial_contents_Channel {
  ...
  owner: SharedChannelPage_channel_initial_contents_Channel_owner;
  label: string;
  can: SharedChannelPage_channel_initial_contents_Channel_can | null;
}

export type SharedChannelPage_channel_initial_contents = SharedChannelPage_channel_initial_contents_Attachment | SharedChannelPage_channel_initial_contents_Embed | SharedChannelPage_channel_initial_contents_Image | SharedChannelPage_channel_initial_contents_Link | SharedChannelPage_channel_initial_contents_PendingBlock | SharedChannelPage_channel_initial_contents_Text | SharedChannelPage_channel_initial_contents_Channel;
...
export interface SharedChannelPage_channel {
  ...
  skeleton: SharedChannelPage_channel_skeleton[] | null;
  initial_contents: SharedChannelPage_channel_initial_contents[] | null;
  meta_title: string;

...
export interface SharedChannelPage_channel_blokks_Channel {
  ...
  owner: SharedChannelPage_channel_blokks_Channel_owner | null;
  label: string | null;
  can: SharedChannelPage_channel_blokks_Channel_can | null;
}

export type SharedChannelPage_channel_blokks = SharedChannelPage_channel_blokks_Text | SharedChannelPage_channel_blokks_Image | SharedChannelPage_channel_blokks_Link | SharedChannelPage_channel_blokks_Embed | SharedChannelPage_channel_blokks_Attachment | SharedChannelPage_channel_blokks_PendingBlock | SharedChannelPage_channel_blokks_Channel;
...
export interface SharedChannelPage_channel {
  ...
  blokks: (SharedChannelPage_channel_blokks | null)[] | null;

...
export interface FeedGroup_objects_Attachment {
  __typename: "Attachment";
  href: string;
  counts: FeedGroup_objects_Attachment_counts;
  id: number;
  title: string;
  src: string | null;
  src_1x: string | null;
  ...
  updated_at: string;
  user: FeedGroup_objects_Attachment_user;
  /**
...
export interface FeedGroup_objects_Channel {
  ...
  visibility: string;
  updated_at: string;
  counts: FeedGroup_objects_Channel_counts;
  owner: FeedGroup_objects_Channel_owner;
  label: string;
  title: string;
  user: FeedGroup_objects_Channel_user;
  /**
   * Returns the outer channel if we are inside of one
   */
...
export interface FeedGroup_objects_Embed {
  __typename: "Embed";
  href: string;
  counts: FeedGroup_objects_Embed_counts;
  id: number;
  title: string;
  src: string | null;
  src_1x: string | null;
  ...
  src_3x: string | null;
  updated_at: string;
  user: FeedGroup_objects_Embed_user;
  /**
   * Returns the outer channel if we are inside of one
   */
...
export interface FeedGroup_objects_Image {
  __typename: "Image";
  href: string;
  counts: FeedGroup_objects_Image_counts;
  id: number;
  title: string;
  ...
  updated_at: string;
  user: FeedGroup_objects_Image_user;
  /**
   * Returns the outer channel if we are inside of one
   */
...
export interface FeedGroup_objects_Link {
  __typename: "Link";
  href: string;
  counts: FeedGroup_objects_Link_counts;
  title: string;
  src: string | null;
  src_1x: string | null;
  src_2x: string | null;
  ...
  content: string | null;
  updated_at: string;
  user: FeedGroup_objects_Link_user;
  /**
   * Returns the outer channel if we are inside of one
   */
...
export interface FeedGroup_objects_Text {
  __typename: "Text";
  href: string;
  counts: FeedGroup_objects_Text_counts;
  id: number;
  title: string;
  content: string;
  raw: string;
  updated_at: string;
  user: FeedGroup_objects_Text_user;
  /**
   * Returns the outer channel if we are inside of one
   */

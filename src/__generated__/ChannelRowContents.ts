...
export interface ChannelRowContents_channel_blokks_Attachment {
  ...
  counts: ChannelRowContents_channel_blokks_Attachment_counts | null;
  src: string | null;
  src_1x: string | null;
  src_2x: string | null;
  src_3x: string | null;
...
export interface ChannelRowContents_channel_blokks_Embed {
  ...
  counts: ChannelRowContents_channel_blokks_Embed_counts | null;
  src: string | null;
  src_1x: string | null;
  src_2x: string | null;
  src_3x: string | null;
...
export interface ChannelRowContents_channel_blokks_Image {
  ...
  counts: ChannelRowContents_channel_blokks_Image_counts | null;
...
export interface ChannelRowContents_channel_blokks_Link {
  ...
  counts: ChannelRowContents_channel_blokks_Link_counts | null;
  src: string | null;
  src_1x: string | null;
  src_2x: string | null;
  src_3x: string | null;
...
export interface ChannelRowContents_channel_blokks_PendingBlock {
  ...
  counts: ChannelRowContents_channel_blokks_PendingBlock_counts | null;
}
...
export interface ChannelRowContents_channel_blokks_Text {
  ...
  counts: ChannelRowContents_channel_blokks_Text_counts | null;
  content: string;
  raw: string;
}
...
export interface ChannelRowContents_channel_blokks_Channel {
  ...
  visibility: string;
  counts: ChannelRowContents_channel_blokks_Channel_counts | null;
...
export interface ChannelRowContents_channel {
  __typename: "Channel";
  id: number;
  blokks: ChannelRowContents_channel_blokks[] | null;
}

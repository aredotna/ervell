...
export interface TableRow_blokk_PendingBlock {
  ...
  updated_at: string;
  title: string;
  user: TableRow_blokk_PendingBlock_user;
  /**
   * Returns the outer channel if we are inside of one
   */
  connection: TableRow_blokk_PendingBlock_connection | null;
  href: string;
  counts: TableRow_blokk_PendingBlock_counts;
}
...
export interface TableRow_blokk_Attachment {
  ...
  updated_at: string;
  title: string;
  user: TableRow_blokk_Attachment_user;
  /**
   * Returns the outer channel if we are inside of one
   */
  connection: TableRow_blokk_Attachment_connection | null;
  counts: TableRow_blokk_Attachment_counts;
...
export interface TableRow_blokk_Embed {
  ...
  updated_at: string;
  title: string;
  user: TableRow_blokk_Embed_user;
  /**
   * Returns the outer channel if we are inside of one
   */
  connection: TableRow_blokk_Embed_connection | null;
  counts: TableRow_blokk_Embed_counts;
...
export interface TableRow_blokk_Image {
  ...
  updated_at: string;
  title: string;
  user: TableRow_blokk_Image_user;
  /**
   * Returns the outer channel if we are inside of one
   */
  connection: TableRow_blokk_Image_connection | null;
  counts: TableRow_blokk_Image_counts;
  image_url: string | null;
  href: string;
  /**
...
export interface TableRow_blokk_Link {
  ...
  updated_at: string;
  title: string;
  user: TableRow_blokk_Link_user;
  /**
   * Returns the outer channel if we are inside of one
   */
  connection: TableRow_blokk_Link_connection | null;
  counts: TableRow_blokk_Link_counts;
  image_url: string | null;
  href: string;
...
export interface TableRow_blokk_Text {
  ...
  updated_at: string;
  title: string;
  user: TableRow_blokk_Text_user;
  /**
   * Returns the outer channel if we are inside of one
   */
  connection: TableRow_blokk_Text_connection | null;
  counts: TableRow_blokk_Text_counts;
  content: string;
  html: string;
  /**
   * URL to find the original image on various services
...
export interface TableRow_blokk_Channel {
  ...
  updated_at: string;
  title: string;
  user: TableRow_blokk_Channel_user;
  /**
   * Returns the outer channel if we are inside of one
   */

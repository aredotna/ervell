...
export interface AdvancedQuickSearchResult_Channel {
  ...
  title: string;
  user: AdvancedQuickSearchResult_Channel_user;
}
...
export interface AdvancedQuickSearchResult_Attachment {
  ...
  title: string;
  href: string;
  user: AdvancedQuickSearchResult_Attachment_user;
  src: string | null;
}
...
export interface AdvancedQuickSearchResult_PendingBlock {
  ...
  title: string;
  href: string;
  user: AdvancedQuickSearchResult_PendingBlock_user;
}
...
export interface AdvancedQuickSearchResult_Embed {
  ...
  title: string;
  href: string;
  user: AdvancedQuickSearchResult_Embed_user;
  src: string | null;
}
...
export interface AdvancedQuickSearchResult_Image {
  ...
  title: string;
  href: string;
  user: AdvancedQuickSearchResult_Image_user;
  src: string | null;
}
...
export interface AdvancedQuickSearchResult_Link {
  ...
  title: string;
  href: string;
  user: AdvancedQuickSearchResult_Link_user;
  src: string | null;
}
...
export interface AdvancedQuickSearchResult_Text {
  ...
  title: string;
  href: string;
  user: AdvancedQuickSearchResult_Text_user;
  content: string;
}

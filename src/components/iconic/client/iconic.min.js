...
!(function(a) {
  'object' == typeof exports
    ...
    ? (global.IconicJS = a())
    : 'undefined' != typeof self && (self.IconicJS = a())
})(function() {
  var a
      ...
      1: [
        function(a, b) {
          var c = (a('./modules/polyfills'), a('./modules/svg-injector')),
              ...
              ;(f.each = function(a) {
                if (a)
                  if ('string' == typeof a) h.debug(a)
                    ...
                    var f = /iconic-bg-/
                    f.test(a.getAttribute('class')) && g.addBackground(a),
                      m(a),
                      k++,
                      b && b.each && 'function' == typeof b.each && b.each(a)
                  }
              }),
            ...
            m = function(a) {
              ...
              a
                ? 'string' == typeof a
                  ...
                  : void 0 !== a.length
                  ? (b = a)
                  : 'object' == typeof a && b.push(a)
                : (b = document.querySelectorAll('svg.iconic')),
                Array.prototype.forEach.call(b, function(a) {
                  a instanceof SVGSVGElement &&
                    (a.update && a.update(), e.refresh(a), f.refresh(a))
                })
            },
            n = function() {
              i.debug &&
                console.time &&
                console.time('autoInjectSelector - ' + i.autoInjectSelector)
              var a = k
              l(i.autoInjectSelector, {}, function() {
                if (
                  (i.debug &&
                    console.timeEnd &&
                    console.timeEnd(
                      'autoInjectSelector - ' + i.autoInjectSelector
                    ),
                  h.debug('AutoInjected: ' + (k - a)),
                  e.refreshAll(),
                  i.autoInjectDone && 'function' == typeof i.autoInjectDone)
                ) {
                  var b = k - a
                  i.autoInjectDone(b)
                }
            ...
            o = function(a) {
              a && '' !== a && 'complete' !== document.readyState
            ...
            p = function(a) {
              return (
                (a = a || {}),
                d(i, a),
                o(i.autoInjectSelector),
                h.enableDebug(i.debug),
                window._Iconic
                  ? window._Iconic
                  : {
                      inject: l,
      ...
      2: [
        function(a, b) {
          var c = function(a) {
            ...
            h.setAttribute('class', e.join(' ')),
              h.appendChild(a),
              f.insertBefore(h, f.childNodes[g])
          }
            ...
            (function() {
              if (
                  ...
                  c = function(b, c) {
                    for (var d = 0; d < a.length; ) {
                      ...
                      if (e.object == this && e.type == b && e.listener == c) {
                        'DOMContentLoaded' == b
                          ? this.detachEvent('onreadystatechange', e.wrapper)
                ...
                ;(Element.prototype.addEventListener = b),
                  ...
                  HTMLDocument &&
                    ((HTMLDocument.prototype.addEventListener = b),
                    (HTMLDocument.prototype.removeEventListener = c)),
                  Window &&
                    ((Window.prototype.addEventListener = b),
                    (Window.prototype.removeEventListener = c))
              }
            })()
        },
        {},
          ...
          var c = function(a) {
            ...
            if (b && '' !== b) {
              ...
              Array.prototype.forEach.call(m, function(a) {
                if (
                  ((c = a.getAttribute('data-width')),
                  (d = a.getAttribute('data-height')),
                  c !== j || d !== k)
                ) {
                  ...
                  ;(g = Math.floor((j / f - c) / 2)),
                    (h = Math.floor((k / f - d) / 2)),
                    Array.prototype.forEach.call(l, function(a) {
                      switch (a) {
                        ...
                        default:
                          console &&
                            console.log &&
                            console.log('Unknown position: ' + a)
                      }
                    }),
                    (i = 0 === h ? g : g + ' ' + h),
                    (i = 'translate(' + i + ')'),
          ...
          var c = /(iconic-sm\b|iconic-md\b|iconic-lg\b)/,
            d = function(a, b) {
              ...
              return (
                !c &&
                  ...
                  (c =
                    a.currentStyle[
                      b.replace(/([a-z])\-([a-z])/, function(a, b, c) {
            ...
            f = function() {
              ...
              navigator &&
                ...
                (a += 'svg.iconic{zoom:1.0001;}')
              var b = document.createElement('style')
              ;(b.id = 'iconic-responsive-css'),
                (b.type = 'text/css'),
                b.styleSheet
        ...
        function(b, c, d) {
          !(function(b, e) {
            ...
            var g = 'file:' === b.location.protocol,
              ...
              r = function(a, c) {
                if (void 0 !== j[a])
                  j[a] instanceof SVGSVGElement ? c(o(j[a])) : p(a, c)
                else {
                  if (!b.XMLHttpRequest)
                    return c('Browser does not support XMLHttpRequest'), !1
                  ;(j[a] = {}), p(a, c)
                  var d = new XMLHttpRequest()
                  ;(d.onreadystatechange = function() {
                    if (4 === d.readyState) {
                      if (404 === d.status || null === d.responseXML)
                        return (
                          c('Unable to load SVG file: ' + a),
                          g &&
                            c(
                      ...
                      if (d.responseXML instanceof Document)
                        j[a] = d.responseXML.documentElement
                        ...
                        if (!b || b.getElementsByTagName('parsererror').length)
                          return c('Unable to parse SVG file: ' + a), !1
              ...
              s = function(a, c, d, e) {
                ...
                if (!h) {
                  var j =
                    a.getAttribute('data-fallback') ||
                    a.getAttribute('data-png')
                  return (
                    j
                      ? (a.setAttribute('src', j), e(null))
                      : d
                      ? (a.setAttribute(
                          'src',
                          d +
                ...
                ;-1 === l.indexOf(a) &&
                  ...
                  a.setAttribute('src', ''),
                  r(g, function(d) {
                    if ('undefined' == typeof d || 'string' == typeof d)
                      return e(d), !1
                    ...
                    Object.keys(v).forEach(function(a) {
                      ;(q = a),
                        (s = v[a]),
                        (r = d.querySelectorAll('defs ' + q + '[id]'))
                    ...
                    for (
                      ...
                      (x = y[A].getAttribute('type')),
                        (x &&
                          ...
                          ((w = y[A].innerText || y[A].textContent),
                          z.push(w),
                          d.removeChild(y[A]))
                    if (
                      z.length > 0 &&

...
app
  .get(
    '/actions/transfer-channel/confirm/:token',
    ...middlewareStack,
    (req, res, next) => {
      req.apollo.client
        .mutate({
        ...
        .then(({ data }) => {
          const {
            accept_channel_transfer: {
              channel_transfer_request: { channel },
            },
          } = data
  ...
  .get(
    '/actions/transfer-channel/reject/:token',
    ...middlewareStack,
    (req, res, next) => {
      req.apollo.client
        .mutate({
        ...
        .then(({ data }) => {
          const {
            reject_channel_transfer: { channel },
          } = data
